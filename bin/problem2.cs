...
// Dafny 3.0.0.30203
// Command Line Options: c:\Users\hp\Desktop\problem2.dfy /verifyAllModules /compile:3 /spillTargetCode:1 /out:bin\problem2
// problem2.dfy

method printArr(a: array<char>)
  decreases a
{
  var i := 0;
  print ""[ "";
...
predicate is_dutch(arr: array?<char>, k: int)
  requires arr != null && arr.Length > 0 && 0 <= k <= arr.Length
  reads arr
  decreases {arr}, arr, k
{
  forall i: int :: 
...
method swap(arr: array?<char>, i: int, j: int)
  requires arr != null && arr.Length > 0 && 0 <= i < arr.Length && 0 <= j < arr.Length
  modifies arr
  ensures i < j ==> arr[..] == old(arr[0 .. i] + [arr[j]] + arr[i + 1 .. j] + [arr[i]] + arr[j + 1..])
  ensures i == j ==> arr[..] == old(arr[..])
  ensures i > j ==> arr[..] == old(arr[0 .. j] + [arr[i]] + arr[j + 1 .. i] + [arr[j]] + arr[i + 1..])
  decreases arr, i, j
{
  var tmp := arr[i];
  arr[i] := arr[j];
...
method dutch(arr: array?<char>) returns (k: int)
  ...
  ensures forall i: int :: 0 <= i < k ==> arr[i] == 'r'
  ensures forall i: int :: k <= i < arr.Length ==> arr[i] != 'r'
  decreases arr
{
  k := 0;
  var m := 0;
  while m < arr.Length
    invariant m <= arr.Length && k <= m
    invariant forall i: int :: 0 <= i < k ==> arr[i] == 'r'
    invariant forall i: int :: k <= i < m ==> arr[i] != 'r'
...
method Main()
{
  ...
  print ""-----------------------------\n"";
  a := new char[6];
  a[0], a[1], a[2], a[3], a[4], a[5] := 'r', 'r', 'r', 'b', 'b', 'b';
  printArr(a);
  k := dutch(a);
  print ""k = "", k, ""\n"";
  printArr(a);
  print ""-----------------------------\n"";
  a := new char[7];
  a[0], a[1], a[2], a[3], a[4], a[5], a[6] := 'r', 'r', 'r', 'r', 'r', 'r', 'r';
  printArr(a);
  k := dutch(a);
  print ""k = "", k, ""\n"";
  printArr(a);
...
namespace _module {
  ...
  public partial class __default {
    public static void printArr(char[] a)
    {
      ...
      while ((_66_i) < (new BigInteger((a).Length))) {
        Dafny.Helpers.Print((a)[(int)(_66_i)]);
        Dafny.Helpers.Print(Dafny.Sequence<char>.FromString(" "));
        _66_i = (_66_i) + (BigInteger.One);
      }
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("]\n"));
    }
    public static void swap(char[] arr, BigInteger i, BigInteger j)
    {
      char _67_tmp;
      _67_tmp = (arr)[(int)(i)];
      (arr)[(int)((i))] = (arr)[(int)(j)];
    ...
    public static BigInteger dutch(char[] arr)
    {
      BigInteger k = BigInteger.Zero;
      k = BigInteger.Zero;
      BigInteger _68_m;
      _68_m = BigInteger.Zero;
      while ((_68_m) < (new BigInteger((arr).Length))) {
        if (((arr)[(int)(_68_m)]) == ('r')) {
          __default.swap(arr, k, _68_m);
          k = (k) + (BigInteger.One);
        }
        _68_m = (_68_m) + (BigInteger.One);
      }
      return k;
    }
    ...
    {
      char[] _69_a;
      char[] _nw0 = Dafny.ArrayHelpers.InitNewArray1<char>('D', Dafny.Helpers.ToIntChecked(new BigInteger(3), "C# arrays may not be larger than the max 32-bit integer"));
      _69_a = _nw0;
      char _rhs0 = 'b';
      char _rhs1 = 'r';
      char _rhs2 = 'b';
      ...
      __default.printArr(_69_a);
      BigInteger _70_k;
      BigInteger _out0;
      _out0 = __default.dutch(_69_a);
      _70_k = _out0;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("k = "));
      Dafny.Helpers.Print(_70_k);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      __default.printArr(_69_a);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("-----------------------------\n"));
      char[] _nw1 = Dafny.ArrayHelpers.InitNewArray1<char>('D', Dafny.Helpers.ToIntChecked(new BigInteger(5), "C# arrays may not be larger than the max 32-bit integer"));
      _69_a = _nw1;
      char _rhs3 = 'b';
      char _rhs4 = 'b';
      char _rhs5 = 'b';
      ...
      char _rhs7 = 'r';
      char[] _lhs6 = _69_a;
      BigInteger _lhs7 = BigInteger.Zero;
      char[] _lhs8 = _69_a;
      BigInteger _lhs9 = BigInteger.One;
      char[] _lhs10 = _69_a;
      BigInteger _lhs11 = new BigInteger(2);
      char[] _lhs12 = _69_a;
      BigInteger _lhs13 = new BigInteger(3);
      char[] _lhs14 = _69_a;
      BigInteger _lhs15 = new BigInteger(4);
      ...
      __default.printArr(_69_a);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("-----------------------------\n"));
      char[] _nw2 = Dafny.ArrayHelpers.InitNewArray1<char>('D', Dafny.Helpers.ToIntChecked(new BigInteger(6), "C# arrays may not be larger than the max 32-bit integer"));
      _69_a = _nw2;
      char _rhs8 = 'r';
      char _rhs9 = 'r';
      char _rhs10 = 'r';
      ...
      char _rhs13 = 'b';
      char[] _lhs16 = _69_a;
      BigInteger _lhs17 = BigInteger.Zero;
      char[] _lhs18 = _69_a;
      BigInteger _lhs19 = BigInteger.One;
      char[] _lhs20 = _69_a;
      BigInteger _lhs21 = new BigInteger(2);
      char[] _lhs22 = _69_a;
      BigInteger _lhs23 = new BigInteger(3);
      char[] _lhs24 = _69_a;
      BigInteger _lhs25 = new BigInteger(4);
      char[] _lhs26 = _69_a;
      BigInteger _lhs27 = new BigInteger(5);
      _lhs16[(int)(_lhs17)] = _rhs8;
      _lhs18[(int)(_lhs19)] = _rhs9;
      _lhs20[(int)(_lhs21)] = _rhs10;
      _lhs22[(int)(_lhs23)] = _rhs11;
      _lhs24[(int)(_lhs25)] = _rhs12;
      _lhs26[(int)(_lhs27)] = _rhs13;
      __default.printArr(_69_a);
      BigInteger _out2;
      _out2 = __default.dutch(_69_a);
      _70_k = _out2;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("k = "));
      Dafny.Helpers.Print(_70_k);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      __default.printArr(_69_a);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("-----------------------------\n"));
      char[] _nw3 = Dafny.ArrayHelpers.InitNewArray1<char>('D', Dafny.Helpers.ToIntChecked(new BigInteger(7), "C# arrays may not be larger than the max 32-bit integer"));
      _69_a = _nw3;
      char _rhs14 = 'r';
      char _rhs15 = 'r';
      char _rhs16 = 'r';
      ...
      char _rhs20 = 'r';
      char[] _lhs28 = _69_a;
      BigInteger _lhs29 = BigInteger.Zero;
      char[] _lhs30 = _69_a;
      BigInteger _lhs31 = BigInteger.One;
      char[] _lhs32 = _69_a;
      BigInteger _lhs33 = new BigInteger(2);
      char[] _lhs34 = _69_a;
      BigInteger _lhs35 = new BigInteger(3);
      char[] _lhs36 = _69_a;
      BigInteger _lhs37 = new BigInteger(4);
      char[] _lhs38 = _69_a;
      BigInteger _lhs39 = new BigInteger(5);
      char[] _lhs40 = _69_a;
      BigInteger _lhs41 = new BigInteger(6);
      _lhs28[(int)(_lhs29)] = _rhs14;
      _lhs30[(int)(_lhs31)] = _rhs15;
      _lhs32[(int)(_lhs33)] = _rhs16;
      _lhs34[(int)(_lhs35)] = _rhs17;
      _lhs36[(int)(_lhs37)] = _rhs18;
      _lhs38[(int)(_lhs39)] = _rhs19;
      _lhs40[(int)(_lhs41)] = _rhs20;
      __default.printArr(_69_a);
      BigInteger _out3;
      _out3 = __default.dutch(_69_a);
      _70_k = _out3;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("k = "));
      Dafny.Helpers.Print(_70_k);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      __default.printArr(_69_a);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("-----------------------------\n"));
      char[] _nw4 = Dafny.ArrayHelpers.InitNewArray1<char>('D', Dafny.Helpers.ToIntChecked(new BigInteger(4), "C# arrays may not be larger than the max 32-bit integer"));
      _69_a = _nw4;
      char _rhs21 = 'b';
      char _rhs22 = 'b';
      char _rhs23 = 'b';
      char _rhs24 = 'r';
      char[] _lhs42 = _69_a;
      BigInteger _lhs43 = BigInteger.Zero;
      char[] _lhs44 = _69_a;
      BigInteger _lhs45 = BigInteger.One;
      char[] _lhs46 = _69_a;
      BigInteger _lhs47 = new BigInteger(2);
      char[] _lhs48 = _69_a;
      BigInteger _lhs49 = new BigInteger(3);
      _lhs42[(int)(_lhs43)] = _rhs21;
      _lhs44[(int)(_lhs45)] = _rhs22;
      _lhs46[(int)(_lhs47)] = _rhs23;
      _lhs48[(int)(_lhs49)] = _rhs24;
      __default.printArr(_69_a);
      BigInteger _out4;
      _out4 = __default.dutch(_69_a);
      _70_k = _out4;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("k = "));
      Dafny.Helpers.Print(_70_k);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      __default.printArr(_69_a);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("-----------------------------\n"));
      char[] _nw5 = Dafny.ArrayHelpers.InitNewArray1<char>('D', Dafny.Helpers.ToIntChecked(BigInteger.One, "C# arrays may not be larger than the max 32-bit integer"));
      _69_a = _nw5;
      (_69_a)[(int)((BigInteger.Zero))] = 'b';
      __default.printArr(_69_a);
      BigInteger _out5;
      _out5 = __default.dutch(_69_a);
      _70_k = _out5;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("k = "));
      Dafny.Helpers.Print(_70_k);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      __default.printArr(_69_a);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("-----------------------------\n"));
      char[] _nw6 = Dafny.ArrayHelpers.InitNewArray1<char>('D', Dafny.Helpers.ToIntChecked(BigInteger.One, "C# arrays may not be larger than the max 32-bit integer"));
      _69_a = _nw6;
      (_69_a)[(int)((BigInteger.Zero))] = 'r';
      __default.printArr(_69_a);
      BigInteger _out6;
      _out6 = __default.dutch(_69_a);
      _70_k = _out6;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("k = "));
      Dafny.Helpers.Print(_70_k);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
