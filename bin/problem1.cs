...
// Dafny 3.0.0.30203
// Command Line Options: c:\Users\hp\Desktop\problem1.dfy /verifyAllModules /compile:3 /spillTargetCode:1 /out:bin\problem1
// problem1.dfy
...
lemma /*{:_induction m, n}*/ square_and_halve(m: int, n: int)
  requires n >= 0
  ...
  decreases m, n
{
  ...
  result := 1;
  while y != 0
    invariant y >= 0 && exp(m, n) == result * exp(x, y)
    decreases y
  {
    if y % 2 == 0 {
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger power(BigInteger m, BigInteger n)
    {
      ...
      while ((_58_y).Sign != 0) {
        if ((Dafny.Helpers.EuclideanModulus(_58_y, new BigInteger(2))).Sign == 0) {
          _57_x = (_57_x) * (_57_x);
          _58_y = Dafny.Helpers.EuclideanDivision(_58_y, new BigInteger(2));
        } else {
          result = (result) * (_57_x);
          _58_y = (_58_y) - (BigInteger.One);
        }
      }
      result = result;
      return result;
    ...
    public static void _Main()
    {
      BigInteger _59_c;
      BigInteger _out0;
      _out0 = __default.power(new BigInteger(2), new BigInteger(3));
      _59_c = _out0;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("power(2, 3) = "));
      Dafny.Helpers.Print(_59_c);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      BigInteger _out1;
      _out1 = __default.power(new BigInteger(5), BigInteger.Zero);
      _59_c = _out1;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("power(5, 0) = "));
      Dafny.Helpers.Print(_59_c);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      BigInteger _out2;
      _out2 = __default.power(new BigInteger(11), BigInteger.One);
      _59_c = _out2;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("power(11, 1) = "));
      Dafny.Helpers.Print(_59_c);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      BigInteger _out3;
      _out3 = __default.power(BigInteger.Zero, BigInteger.Zero);
      _59_c = _out3;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("power(0, 0) = "));
      Dafny.Helpers.Print(_59_c);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      BigInteger _out4;
      _out4 = __default.power(new BigInteger(8), new BigInteger(2));
      _59_c = _out4;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("power(8, 2) = "));
      Dafny.Helpers.Print(_59_c);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      BigInteger _out5;
      _out5 = __default.power(new BigInteger(-2), new BigInteger(3));
      _59_c = _out5;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("power(-2, 3) = "));
      Dafny.Helpers.Print(_59_c);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
      BigInteger _out6;
      _out6 = __default.power(new BigInteger(-3), new BigInteger(2));
      _59_c = _out6;
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("power(-3, 2) = "));
      Dafny.Helpers.Print(_59_c);
      Dafny.Helpers.Print(Dafny.Sequence<char>.FromString("\n"));
    }
  }
